...
class INA:
    ...
    def __repr__(self):
        s = "@Bus#{} <{}> {} -- Max-I: {}, R: {}".format(self.bus_num, self.device_id, self.ina_long_id, self.max_current, self.r_shunt)
        return s
